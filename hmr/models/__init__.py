...
from ..configs import CACHE_DIR_4DHUMANS, PROJECT_ROOT


CANONICAL_SMPL_PATH = os.path.join(PROJECT_ROOT, "checkpoint", "SMPL_NEUTRAL.pkl")
...
def download_models(folder=CACHE_DIR_4DHUMANS):
    ...
    required_paths = [
        CANONICAL_SMPL_PATH,
        os.path.join(folder, "logs", "train", "multiruns", "hmr2", "0", "model_config.yaml"),
...
def check_smpl_exists():
    ...
    candidates = [
        CANONICAL_SMPL_PATH,
        os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "data", "basicModel_neutral_lbs_10_207_0_v1.0.0.pkl")),
    ]
    ...
    # Keep a Python 3-compatible SMPL pickle at the canonical checkpoint path.
