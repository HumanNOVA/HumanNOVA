...
CHECKPOINT_DIR_4DHUMANS = os.path.join(PROJECT_ROOT, "checkpoint", "4DHumans")
ASSETS_DIR_4DHUMANS = os.path.join(PROJECT_ROOT, "assets", "4DHumans")
CACHE_DIR_4DHUMANS = (
    CHECKPOINT_DIR_4DHUMANS
    if os.path.exists(CHECKPOINT_DIR_4DHUMANS)
    else ASSETS_DIR_4DHUMANS
)
...
def get_config(config_file: str, merge: bool = True, update_cachedir: bool = False) -> CN:
    ...
    if update_cachedir:
      ...
      cfg.SMPL.MODEL_PATH = os.path.join(PROJECT_ROOT, "checkpoint")
